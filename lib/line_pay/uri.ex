defmodule LinePay.URI do
  @moduledoc """
  LinePay URI helpers to encode nested dictionaries as query_params.
  """
  ...
  LinePay.URI.encode_query(card) # card[number]=424242424242&card[exp_year]=2014
  """
